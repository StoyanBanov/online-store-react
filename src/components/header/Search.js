    ...
    return (
        <div className={style.searchBar}>
            <form onSubmit={submitHandler} onBlur={closeHandler && blurHandler}>
                <input style={{ width }} value={searchValue} onChange={searchValueChangeHandler} onKeyUp={typeHandler} autoFocus={autoFocus} />
                ...
                <div className={style.searchBarResultsContainer}>
